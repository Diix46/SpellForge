...
const messages: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'auth.subRegister': 'Rejoignez la forge',
    ...
    'coach.starterDiagnose': 'Diagnostique mon deck : quelle est sa plus grosse faiblesse ?',
    'coach.starterCut': 'Quelles cartes je devrais couper, et pourquoi ?',
    'coach.starterFind': 'Trouve-moi des cartes pas chères qui renforcent ma stratégie.',
    ...
    'dash.quickImport': 'Un deck tout fait en un lien',
    ...
    'buy.wholeDeckHint': 'On copie la liste et on ouvre Cardmarket : collez-la (Ctrl+V) pour remplir votre panier d\'un coup.',
    ...
    'landing.f1Body': 'Un assistant qui lit VRAIMENT votre deck — courbe, rôles, identité — et propose des cartes réelles, validées, jamais d\'hallucination.',
    'landing.f2Title': 'Proxies parfaits',
    'landing.f2Body': 'Export PDF A4 ou A3, recto-verso, repères de coupe. Vos cartes en français ou en anglais, prêtes à imprimer.',
    ...
    'landing.f6Body': 'Recherche instantanée, glisser-déposer, ⌘K, vignettes immédiates. Construire un deck devient un plaisir.',
    'landing.stepsKicker': 'Trois étapes',
    ...
    'landing.s3Body': 'Export PDF impeccable, à la table en quelques minutes.',
    'landing.finalKicker': 'Votre prochaine soirée commence ici',
  ...
  en: {
    ...
    'auth.subRegister': 'Join the forge',
    ...
    'dash.quickImport': 'A ready-made deck from a link',
    ...
    'buy.wholeDeckHint': 'We copy the list and open Cardmarket — just paste it (Ctrl+V) to fill your cart in one go.',
    ...
    'landing.f1Body': 'An assistant that actually reads your deck — curve, roles, identity — and suggests real, validated cards. Never a hallucination.',
    'landing.f2Title': 'Flawless proxies',
    'landing.f2Body': 'PDF export in A4 or A3, double-faced, with cut guides. Your cards in English or French, ready to print.',
    ...
    'landing.f5Title': 'Colour identity',
    'landing.f5Body': 'Commander detection, WUBRG identity lock, colour spread and mana curve — all automatic.',
    'landing.f6Title': 'Built for speed',
    'landing.f6Body': 'Instant search, drag & drop, ⌘K, immediate thumbnails. Building a deck becomes a joy.',
    'landing.stepsKicker': 'Three steps',
    ...
    'landing.s3Body': 'Flawless PDF export, at the table in minutes.',
    'landing.finalKicker': 'Your next game night starts here',
