...
const messages: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'landing.f4Title': 'Prix en direct',
    'landing.f4Body': 'Coût total estimé, prix par carte, et achat du deck entier sur Cardmarket en un clic.',
    'landing.f5Title': 'Identité couleur',
    'landing.f5Body': 'Détection du commandant, verrou d\'identité WUBRG, répartition des couleurs et courbe de mana — automatiques.',
    'landing.f6Title': 'Pensé pour la vitesse',
    'landing.f6Body': 'Recherche instantanée, glisser-déposer, ⌘K, vignettes immédiates.',
  ...
  en: {
    ...
    'landing.f4Title': 'Live pricing',
    'landing.f4Body': 'Estimated total cost, per-card prices, and buy the whole deck on Cardmarket in one click.',
    'landing.f5Title': 'Color identity',
    'landing.f5Body': 'Commander detection, WUBRG identity lock, color spread and mana curve — all automatic.',
    'landing.f6Title': 'Built for speed',
    'landing.f6Body': 'Instant search, drag & drop, ⌘K, immediate thumbnails.',
